...
class Solution {
    ...
    public int pickIndex() {
        int target = rand.nextInt(w[w.length - 1]) + 1;
...
// Success
// Details 
// Runtime: 21 ms, faster than 90.58% of Java online submissions for Random Pick with Weight.
// Memory Usage: 44.1 MB, less than 13.36% of Java online submissions for Random Pick with Weight.
